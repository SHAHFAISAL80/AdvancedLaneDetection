...
def pipeline(frame):
    ...
    # Disabled, technically each frame needs to be undistored before being processed.
...
if __name__ == "__main__":
    infile = r"C:\Users\Atif Traders\Videos\New projects\AdvancedLaneDetection-master\data\dashcam_video_trim.mp4"
    outfile = r"C:\Users\Atif Traders\Videos\New projects\AdvancedLaneDetection-master\data\dashcam_video_trim_output.mp4"
    main(infile, outfile)
